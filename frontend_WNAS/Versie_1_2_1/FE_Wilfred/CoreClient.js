...
var DCOCall = (function()
{
    ...
    function _DCOCall()
    {
        ...
        this.transfer       = function( targetNumber, ringTimeout )
        {
            CoreClient.send(
                {
    ...
    return new function()     
    {
        ...
        this.transfer       = function( targetNumber, 
...
var CoreClient = (function()
{
    ...
    function _CoreClient()
    {
        this.initialize = function( url, callback )
        {
            ...
            _callback               = callback;
            _targetURL              = url;
            _target                 = document.createElement( "iframe" );
            _target.id              = "__CoreClient";
            _target.src             = _targetURL + "#" + document.location.href;
            _target.frameBorder     = "0";
        ...
        {
            return setTimeout( System.methodize( this, function() { this._dispatch( System.parse( message ) );} ), 0 );
        };
        ...
        this.callTransfer       = function( phoneNumber ) { return DCOCall.transfer( phoneNumber ); };
